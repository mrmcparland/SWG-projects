...
namespace MVC_SIS_Data
{
    public class StateRepository
    {
        ...
        {
            //System.Diagnostics.Debug.WriteLine("State abbr is " + stateAbbreviation);
        ...
        public static void Add(string stateName, string stateAbbrevation)
        {
            State state = new State();
            state.StateName = stateName;
            state.StateAbbreviation = stateAbbrevation;
            _courses.Add(state);
        }

        /*
        public static void Add(string stateAbbreviation)
        {
            State state = new State();
